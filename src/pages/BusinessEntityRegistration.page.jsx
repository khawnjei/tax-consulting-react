...
import ItinForm from "../components/ContactForm/ItinForm";
...
const BusinessEntityRegistration = () => {
  return (
    <>
      {/* Page Banner section  */}
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12 text-center">
              ...
              <h3 className="sec-title">Business Entity Registration Form</h3>
            </div>
          </div>
          <div className="row">
...
export default BusinessEntityRegistration;
